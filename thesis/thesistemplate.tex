...
The algorithm is studied and implemented because it is representative and easy to implement. This algorithm is used because it is representative of the congested clique model.
\begin{itemize}
	\item[--] The computation graph is fully connected, In the algorithm, there is a step where messages are passed through every connection in the network.
	\item[--] To comply with the bandwidth limit, the data from cluster leaders is spreaded to cluster menders before doing inter-cluster communication.
	\item[--] The algorithm needs several iterations before its convergence.
\end{itemize}
In this work, The algorithm's compatibility is defined by firstly, how easy it is to translate the code:
\begin{itemize}
	\item[--] How to simulate local computation in a distributed setting.
	\item[--] How to simulate message passing in the congested clique.
	\item[--] How to deal with the bandwidth constraints in the congested clique.
\end{itemize}
...
\begin{itemize}
	\item[--] Faster speed.
	\item[--] able to process more edges.
\end{itemize}
...
\begin{thebibliography}{99}
	...
	\item[{[1]}] Zvi Lotker, Boaz Patt-Shamir, Elan Pavlov, and David Peleg,” 
	\textit{SIAM Journal on Computing}, 35(1):120–131, 2005.
	\url{doi.org/10.1137/S0097539704441848}
\end{thebibliography}
